...
A service is approaching.
A service is due today.
A maintenance schedule is overdue.
...
Business Rule Testing
 ...
 Driver on leave cannot be assigned
 Driver with an active trip cannot receive another active trip
 Invalid vehicle validation
 Invalid driver validation
 Duplicate maintenance alert prevention
...
Celery Testing
 ...
 Maintenance reminder execution
